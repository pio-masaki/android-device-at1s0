...
-include vendor/toshiba/tostab04/BoardConfigVendor.mk
...
# EGL settings
BOARD_EGL_CFG := device/toshiba/tostab04/prebuilt/egl.cfg
...
#TARGET_PREBUILT_KERNEL := device/toshiba/tostab04/kernel

# Prebuilt Kernel for recovery
#TARGET_PREBUILT_KERNEL := device/toshiba/tostab04/recovery_kernel

# Custom Tools
#TARGET_RELEASETOOL_OTA_FROM_TARGET_SCRIPT := device/toshiba/tostab04/releasetools/tostab04_ota_from_target_files

# Recovery Options
BOARD_CUSTOM_BOOTIMG_MK := device/toshiba/tostab04/recovery/recovery.mk
BOARD_HAS_NO_MISC_PARTITION := true
BOARD_HAS_NO_SELECT_BUTTON := true
BOARD_HAS_LARGE_FILESYSTEM := true
TARGET_RECOVERY_INITRC := device/toshiba/tostab04/recovery/init.rc
