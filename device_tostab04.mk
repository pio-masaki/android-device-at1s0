...
$(call inherit-product-if-exists, vendor/toshiba/tostab04/tostab04-vendor.mk)

DEVICE_PACKAGE_OVERLAYS += device/toshiba/tostab04/overlay

# Prebuilt kernel location
ifeq ($(TARGET_PREBUILT_KERNEL),)
	LOCAL_KERNEL := device/toshiba/tostab04/kernel
else
...
# tiny_hal
PRODUCT_PACKAGES += audio.primary.tostab04
PRODUCT_COPY_FILES += $(LOCAL_PATH)/prebuilt/etc/sound/tiny_hw.xml:system/etc/sound/tostab04_tiny_hal.xml
...
PRODUCT_NAME := full_tostab04
PRODUCT_DEVICE := tostab04
PRODUCT_MODEL := tostab04
